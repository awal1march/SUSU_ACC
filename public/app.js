...
//     return show("Please login first ❌");
//   }
...
//   document
//     .getElementById(tab === "auth" ? "tabAuth" : "tabWallet")
...
//     show("Network error ❌ (check backend)");
//   }
// }
...
//   if (!token) return show("Login required ❌");
...
//     if (!res.ok) {
//       return show(data.message || "Failed to fetch balance ❌");
//     }
...
//         .then((r) => r.json())
//         .then((d) => {
//           show(d.message || "Payment successful ✅");
//           balance();
//         })
//         .catch((err) => {
//           console.log("PAYSTACK VERIFY ERROR:", err);
...
//   bind("loginBtn", login);
//   bind("balanceBtn", balance);
//   bind("payBtn", pay);
//   bind("logoutBtn", logout);

//   bind("tabAuth", () => showTab("auth"));
//   bind("tabWallet", () => showTab("wallet"));
